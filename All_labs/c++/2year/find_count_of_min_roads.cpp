...
int main() {
    // Граф: города и рёбра
    vector<Edge> edges = {
        Edge(0, 1, 2), Edge(1, 2, 5), Edge(2, 3, 4), Edge(3, 4, 3),
        Edge(4, 2, 6), Edge(4, 5, 7), Edge(5, 2, 6), Edge(5, 1, 13),
        Edge(5, 0, 7)
    };
